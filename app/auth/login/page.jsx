            ...
            <div className="flex items-center justify-between">
              <div className="flex gap-2 items-center mt-6">
                <input
                  ...
                  id="remember"
                />
                <label className="text-lg cursor-pointer font-bold" htmlFor="remember">
                  Remember me
                </label>
              </div>
              <Link href="/auth/forgotpassword" className="text-blue-600 text-lg font-semibold hover:underline mt-6">
                Forgot Password?
              </Link>
            </div>
            <button
